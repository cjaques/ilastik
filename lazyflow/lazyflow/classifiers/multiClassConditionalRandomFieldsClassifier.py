...
import sys
# sys.path.append('/Users/Chris/Code/python_tests/boostWrapper/build/')
# import libslic as slic # TODO Chris - virer ceci

import logging
logger = logging.getLogger(__name__)

class MCConditionalRandomFieldsClassifier(LazyflowVectorwiseClassifierFactoryABC):
    ...
    def __init__(self, num_trees_total=100, num_forests=None, **kwargs):
        ...
        # shape = (20,30)
        # x = 2.0*np.ones( shape, dtype=np.float32 )
        # x[1,3] = 20.0
        # li byay.yay()

        # slic.DispImage(x) #.view(np.ndarray))
