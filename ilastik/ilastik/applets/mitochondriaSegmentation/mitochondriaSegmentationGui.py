...
class ClassifierSelectionDlg(QDialog):
    ...
    """
    def __init__(self, opMitochondriaSegmentation, parent):
        super( QDialog, self ).__init__(parent=parent)
        self._op = opMitochondriaSegmentation
    ...
    def _get_available_classifier_factories(self):
        ...
        classifiers["Parallel Random Forest (VIGRA)"] = ParallelVigraRfLazyflowClassifierFactory(100)  # TODO : Chris - change to new algorithm
        
        print " Function called, where are we?  - " # TODO : CHRIS - virer ce vilain print de debug
...
class MitochondriaSegmentationGui(LabelingGui):
    ...
    def stopAndCleanUp(self):
        ...
        # Base class
        super(MitochondriaSegmentationGui, self).stopAndCleanUp()

    def viewerControlWidget(self):
        return self._viewerControlUi

    def menus( self ):
        menus = super( MitochondriaSegmentationGui, self ).menus()
    ...
    def __init__(self, parentApplet, topLevelOperatorView, labelingDrawerUiPath=None ):
        ...
        # Base class init
        super(MitochondriaSegmentationGui, self).__init__( parentApplet, labelSlots, topLevelOperatorView, labelingDrawerUiPath )
    ...
    def setupLayers(self):
        ...
        layers = super(MitochondriaSegmentationGui, self).setupLayers()
    ...
    def _onLabelRemoved(self, parent, start, end):
        ...
        super(MitochondriaSegmentationGui, self)._onLabelRemoved(parent, start, end)
    ...
    def getNextLabelName(self):
        return self._getNext(self.topLevelOperatorView.LabelNames,
                             super(MitochondriaSegmentationGui, self).getNextLabelName)

    def getNextLabelColor(self):
        return self._getNext(
            self.topLevelOperatorView.LabelColors,
            super(MitochondriaSegmentationGui, self).getNextLabelColor,
            lambda x: QColor(*x)
        )
    ...
    def getNextPmapColor(self):
        return self._getNext(
            ...
            super(MitochondriaSegmentationGui, self).getNextPmapColor,
            lambda x: QColor(*x)
        )

    def onLabelNameChanged(self):
        self._onLabelChanged(super(MitochondriaSegmentationGui, self).onLabelNameChanged,
                             lambda l: l.name,
                             self.topLevelOperatorView.LabelNames)

    def onLabelColorChanged(self):
        self._onLabelChanged(super(MitochondriaSegmentationGui, self).onLabelColorChanged,
    ...
    def onPmapColorChanged(self):
        self._onLabelChanged(super(MitochondriaSegmentationGui, self).onPmapColorChanged,
