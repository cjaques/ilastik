...
class MitochondriaSegmentationDataExportGui( DataExportGui ):
    """
    A subclass of the generic data export gui that creates custom layer viewers.
    """
    def createLayerViewer(self, opLane):
        return MitochondriaSegmentationResultsViewer(self.parentApplet, opLane)
        
class MitochondriaSegmentationResultsViewer(DataExportLayerViewerGui):
    
    def __init__(self, *args, **kwargs):
        super(MitochondriaSegmentationResultsViewer, self).__init__(*args, **kwargs)
