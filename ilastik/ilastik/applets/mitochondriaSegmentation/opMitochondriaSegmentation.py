...
from lazyflow.classifiers import multiClassConditionalRandomFieldsClassifier as MCCRFC  # MCConditionalRandomFieldsClassifier# TODO : CHris - here's the meat
...
class OpMitochondriaSegmentation( Operator ):
    """
    Top-level operator for mitochondria segmentation
    """
    name="OpMitochondriaSegmentation"
    category = "Top-level"
    ...
    ClassifierFactory = InputSlot(value=MCCRFC.MCConditionalRandomFieldsClassifier(100)) # TODO Chris - again, meat
    ...
    def __init__( self, *args, **kwargs ):
        ...
        """
        super(OpMitochondriaSegmentation, self).__init__(*args, **kwargs)
        ...
        self.classifier_cache.name = "OpMitochondriaSegmentation.classifier_cache"
