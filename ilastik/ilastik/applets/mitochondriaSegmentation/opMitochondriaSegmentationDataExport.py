...
class OpMitochondriaSegmentationDataExport( OpDataExport ):
    ...
    def __init__(self,*args,**kwargs):
        super(OpMitochondriaSegmentationDataExport, self).__init__(*args, **kwargs)
    ...
    def propagateDirty(self, slot, subindex, roi):
        if slot is not self.PmapColors and slot is not self.LabelNames:
            super( OpMitochondriaSegmentationDataExport, self ).propagateDirty(slot, subindex, roi)
